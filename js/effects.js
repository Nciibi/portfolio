(function () {
  ...
  const interactiveSelector = ".btn-cyber, .menu-tab, .chrome-control, .mobile-menu-toggle, .lvl, .exp-tab, .project-card, .dlg-opt, .netlink-btn, .social-link, .gh-repo, .gh-refresh, .option-row";
